...
document.getElementById('column1').innerHTML = "<h3>This is amazing! I changed it.</h3>";
document.getElementById('column1').innerHTML += "<p>I did it again! I can even add more</p>";
document.getElementById('column1').innerHTML += "<p> Oh yes! This is it!</p>";
document.getElementById('column1').innerHTML += "<img class='img-fluid' src='images/code.jpg' alt='Man holding a note says code'>";
...
document.getElementById('column2').style.color = "#1FAC5E";
document.getElementById('column2').style.backgroundColor = "#D1F1E0";
...
}else { console.log ("Illegal weapon use");
}
...
//if the weapon is squid, damage points is 50
//but if the weapon is dof, damage is 25
//otherwise te damage will be 0
